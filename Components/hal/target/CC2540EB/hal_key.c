...
/* BOOT is at P1.0 */
#define HAL_KEY_BOOT_PORT   P1
#define HAL_KEY_BOOT_BIT    BV(0)
#define HAL_KEY_BOOT_SEL    P1SEL
#define HAL_KEY_BOOT_DIR    P1DIR
#define HAL_KEY_BOOT_IEN      IEN2  /* CPU interrupt mask register */
#define HAL_KEY_BOOT_ICTL     P1IEN /* Port Interrupt Control register */
#define HAL_KEY_BOOT_ICTLBIT  BV(0) /* P1IEN - P0.0 enable/disable bit */
#define HAL_KEY_BOOT_IENBIT   BV(4) /* Mask bit for all of Port_1 */
#define HAL_KEY_BOOT_PXIFG    P1IFG /* Interrupt flag at source */
#define HAL_KEY_BOOT_EDGEBIT  BV(1)
...
void HalKeyInit( void )
{
  ...
  HAL_KEY_SW_2_DIR &= ~(HAL_KEY_SW_2_BIT);    /* Set pin direction to Input */
    ...
    P0INP =0; //pull UP /down input mode
...
//#if defined ( CC2540_MINIDK )
  ...
  PICTL &= ~HAL_KEY_BOOT_EDGEBIT;   /* Rising edge on input gives interrupt. P1.0 */
