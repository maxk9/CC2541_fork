...
#define PxIFG                      P1IFG
#define PxIF                       P1IF
#define DMA_RDYIn                  P1_7
#define DMA_RDYOut                 P1_6
#define DMA_RDYIn_BIT              BV(7)        // Same as the I/O Select for CTS flow control.
#define DMA_RDYOut_BIT             BV(6)        // Same as the I/O Select for manual RTS flow ctrl.
...
static uint16 HalUARTWriteDMA(uint8 *buf, uint16 len)
{
  ...
  while(!dmaCfg.txMT);//wait while transmit
