...
#define UART_TEST_DATA "I'm started!!!"

uint8 __xdata uartTxBuffer[SIZE_OF_UART_TX_BUFFER] = UART_TEST_DATA;


void print_mark(uint8 x)
{
  uartTxBuffer[0]='\n';
  uartTxBuffer[1]='\r';
  uartTxBuffer[2]='s';
  ...
  uartTxBuffer[4]='\n';
  uartTxBuffer[5]='\r';
  HalUARTWrite(HAL_UART_PORT_1,uartTxBuffer,6);
}
/**************************************************************************************************
 * FUNCTIONS
 **************************************************************************************************/
...
//  HalUARTWrite(HAL_UART_PORT_1,uartTxBuffer,14);//print i'm started
